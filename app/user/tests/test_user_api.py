...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        ...
        invalid_credentials = {'email': 'test@test.com', 'password': 'WRONG'}
        res = self.client.post(TOKEN_URL, invalid_credentials)
    ...
    def test_retrive_user_unauthorized(self):
        """
        Test that autentication is required for users
        """
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        """
        Test updating the user provile for autenticated user
        """
